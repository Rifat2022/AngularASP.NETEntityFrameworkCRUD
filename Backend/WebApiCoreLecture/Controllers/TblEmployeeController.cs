...
namespace WebApiCoreLecture.Controllers
{
    ...
    public class TblEmployeeController : ControllerBase
    {
        ...
        public TblEmployeeController(EmployeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<TblEmployee>>> GetTblEmployee()
        {
          if (_context.TblEmployee == null)
          {
            ...
            //write ctrl + space to get the table columns
