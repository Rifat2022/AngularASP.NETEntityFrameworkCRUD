...
namespace WebApiCoreLecture.Controllers
{
    ...
    public class TblDesignationController : ControllerBase
    {
        ...
        public TblDesignationController(EmployeeContext context)
        {
            _context = context;
        }

        // GET: api/TblDesignation
        [HttpGet]
