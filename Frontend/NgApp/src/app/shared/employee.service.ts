...
import { Employee, Designation } from './employee.model';
@Injectable({
  providedIn: 'root'
})
export class EmployeeService {
  constructor(private myhttp:HttpClient) { }
  employeeUrl:string='https://localhost:7108/api/TblEmployee';
  designationUrl:string='https://localhost:7108/api/TblDesignation';
